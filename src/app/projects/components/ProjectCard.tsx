...
const ProjectCard = (props: Project) => {
    ...
    return (
        <MagicCard className="cursor-pointer rounded-lg dark:shadow-2xl w-[45%] max-sm:w-[85%] max-sm:mx-auto h-[310px] border-none !bg-transparent" gradientColor={`${isDarkMode ? '#262626' : 'rgba(197, 241, 241, 0.4)'}`}>
